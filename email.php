<?php
    ...
    $productsProvided = $_POST["products_provided"] ?? null;
    $propertyNumber = $_POST["property_num"] ?? null;
    ...
    $pictures = $_POST["pictures"] ?? null;
    $cleanType = $_POST["cleantype"];
    $windows = $_POST["windows"] ?? null;
    $oven = $_POST["oven"] ?? null;
    $laundry = $_POST["laundry"] ?? null;
...
foreach ($_FILES["pictures"]["name"] as $k => $v) {
    if (isset($_FILES['pictures'])) {
        ...
        $file_name_array = explode('.',$_FILES['pictures']['name'][$k]);
